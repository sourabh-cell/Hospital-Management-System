...
import com.example.hospitalManagementSystem.noticeBoard.mapper.NoticeMapper;
import com.example.hospitalManagementSystem.noticeBoard.repo.NoticeRepo;
...
public class NoticeServiceImpl implements NoticeService {
    ...
    public List<NoticeDTO> getAllNotices() {
        ...
        return noticeRepo.findAll().stream().map(n->
        {
